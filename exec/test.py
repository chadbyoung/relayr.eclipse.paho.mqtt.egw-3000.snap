...
# This file is to be used a guide. In the desire to make this work I have
# decided to hard code the file paths

# from os import path

# this section will be edited depending on the location of the sensor
FILE_PATH = "/sys/bus/iio/devices/iio:device1/name"
FILE_RAW = "/sys/bus/iio/devices/iio:device1/in_temp_raw"
FILE_OFFSET = "/sys/bus/iio/devices/iio:device1/in_temp_offset"
FILE_SCALE = "/sys/bus/iio/devices/iio:device1/in_temp_scale"
